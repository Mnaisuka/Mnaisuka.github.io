...
ListDisplay.prototype = {
	...
	badgeDescription: {
		"status-not-updated": "模组尚未在最新版本中更新或测试，可能仍然可以使用，但也有可能因更新而出现问题",
		"status-working": "模组已确认可在最新版本中正常运行",
		"status-not-working": "模组在当前版本中无法使用。请查看“测试版本”信息，了解最后的兼容版本",
		"status-with-issues": "模组可运行，但存在一些问题，详见模组详情信息",
		"justupdated": "模组在过去一周内已更新",
		"new": "模组在过去一周内新发布"
	},
